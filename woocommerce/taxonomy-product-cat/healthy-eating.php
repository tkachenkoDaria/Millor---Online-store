			...
			<div class="col-lg-12">
				<div class="food-category-wrapp">
					...
					foreach ($woo_categories as $woo_cat) {
						...
						if (is_product_category('healthy-eating')) {
							$class_active = '';
						} elseif (is_product_category($woo_cat)) {
							$class_active = 'active-cat';
						}
					?>
						<a class="food-catalog-card <?php echo $class_active; ?>" href="<?php echo get_term_link($woo_cat_id, 'product_cat'); ?>">
							<img class="food-catalog-card__img" src="<?php echo $thumbnail_image_url; ?>" alt="category img">
							<p class="food-catalog-card__name">
