			...
			<div class="col-lg-12">
				<div class="tea-category-wrapp">
					...
					foreach ($woo_categories as $woo_cat) {
						...
						if (is_product_category('tea-and-coffee-drinks')) {
							$class_active = '';
						} elseif (is_product_category($woo_cat)) {
							$class_active = 'active-cat';
						}
					?>
						<a class="tea-category-card <?php echo $class_active; ?>" href="<?php echo get_term_link($woo_cat_id, 'product_cat'); ?>">
							<img class="tea-category-card__img" src="<?php echo $thumbnail_image_url; ?>" alt="category img">
							<p class="tea-category-card__name">
