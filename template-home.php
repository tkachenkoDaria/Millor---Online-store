...
<section class="info-coffe" style="background: linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url(<?php the_field('home_info_coffe_img'); ?>) no-repeat center / cover;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<?php
